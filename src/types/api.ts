...
export type NecessidadeInformacaoResponse =
  GetNecessidadesInformacao200["data"][number];
...
export type ListaClassificacaoResponse =
  GetListasClassificacao200["data"][number];
export type ClassificacaoInformacaoResponse =
  GetClassificacoesInformacao200["data"][number];
export type BancoResponse = GetBancos200["data"][number];
export type RepositorioDocumentoResponse =
  GetRepositoriosDocumento200["data"][number];
...
export type DimensaoQualidadeResponse =
  GetDimensoesQualidade200["data"][number];
...
export type CriticidadeRegulatoriaResponse =
  GetCriticidadesRegulatorias200["data"][number];
...
export type GetPoliticasInternas200DataItem =
  GetPoliticasInternas200["data"][number];
