...
const uuidRequired = (campo: string) => z.uuid().min(1, `${campo} é obrigatória`);
...
export type CreateClassificacaoInformacaoFormData = z.infer<
  typeof CreateClassificacaoInformacaoSchema
>;
export type UpdateClassificacaoInformacaoFormData = z.infer<
  typeof UpdateClassificacaoInformacaoSchema
>;
...
export type CreateCriticidadeRegulatoriaFormData = z.infer<
  typeof CreateCriticidadeRegulatoriaSchema
>;
export type UpdateCriticidadeRegulatoriaFormData = z.infer<
  typeof UpdateCriticidadeRegulatoriaSchema
>;
