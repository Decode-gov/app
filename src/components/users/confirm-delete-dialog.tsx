...
export function ConfirmDeleteDialog({ open, onClose, user, onConfirm }: ConfirmDeleteDialogProps) {
  return (
      ...
      <AlertDialogContent className="bg-background/95 backdrop-blur-md border-border/50">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <span className="font-semibold text-foreground">{user?.nome}</span>? Esta ação não pode
            ser desfeita.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
