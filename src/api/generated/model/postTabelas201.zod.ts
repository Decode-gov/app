...
export const postTabelas201DataNomeMax = 255;
...
export const PostTabelas201 = zod.object({
  message: zod.string().describe("Mensagem de resposta"),
  data: zod.object({
    nome: zod
      .string()
      .min(1)
      .max(postTabelas201DataNomeMax)
      .describe("Nome da tabela"),
    bancoId: zod
      .union([
        zod.uuid().regex(postTabelas201DataBancoIdOneRegExp),
...
export type PostTabelas201 = zod.input<typeof PostTabelas201>;
export type PostTabelas201Output = zod.output<typeof PostTabelas201>;
