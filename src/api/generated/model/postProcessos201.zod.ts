...
export const postProcessos201DataIdRegExp = new RegExp(
  "^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$",
);
export const postProcessos201DataNomeMax = 255;

export const PostProcessos201 = zod.object({
  message: zod.string().describe("Mensagem de resposta"),
  data: zod.object({
    id: zod
      .uuid()
      .regex(postProcessos201DataIdRegExp)
      .describe("Identificador único do processo"),
    nome: zod
      .string()
      .min(1)
      .max(postProcessos201DataNomeMax)
...
export type PostProcessos201 = zod.input<typeof PostProcessos201>;
export type PostProcessos201Output = zod.output<typeof PostProcessos201>;
