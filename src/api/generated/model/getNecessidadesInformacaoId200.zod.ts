...
export const getNecessidadesInformacaoId200DataIdRegExp = new RegExp(
  "^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$",
);

export const GetNecessidadesInformacaoId200 = zod.object({
  message: zod.string().describe("Mensagem de resposta"),
  data: zod.object({
    id: zod
      .uuid()
      .regex(getNecessidadesInformacaoId200DataIdRegExp)
...
export type GetNecessidadesInformacaoId200 = zod.input<
  typeof GetNecessidadesInformacaoId200
>;
export type GetNecessidadesInformacaoId200Output = zod.output<
  typeof GetNecessidadesInformacaoId200
>;
